...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        var self = this;
        var CardIndexStart = 0;
        var showType = this.CardFrameMidName[this.CardShowType];
        ...
        var cardid = tools.fix(CardIndexStart + this.CardIndex - 1, 4);
...
cc._RFpop();
},{"Tools":"Tools"}],"GameData":[function(require,module,exports){
"use strict";
...
cc._RFpop();
},{"socket.io":"socket.io"}],"Loading":[function(require,module,exports){
"use strict";
cc._RFpush(module, 'b8592lXW6lFp4sStVnV6D5h', 'Loading');
// Script/Loading/Loading.js
